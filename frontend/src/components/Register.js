  ...
  return (
    <section className="auth">
      ...
      <form className="auth__form" name="login" method="POST" noValidate onSubmit={handleFormSubmit}>
        ...
        <span className="auth__error"></span>
        <button className="auth__submit" ref={subminButtonRef} type="submit">Зарегистрироваться</button>
      </form>
      <p className="auth__comment">Уже зарегистрированы? <Link className="auth__link" to="/sign-in">Войти</Link></p>
    </section>
  );
}
